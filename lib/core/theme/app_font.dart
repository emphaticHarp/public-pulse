...
class AppTextStyles {
  ...
  static const TextStyle inputText = TextStyle(fontSize: 14);
...
class AppShadow {
  ...
  static const List<BoxShadow> sm = [
    BoxShadow(color: AppColors.shadowSm, blurRadius: 4, offset: Offset(0, 1)),
  ];

  static const List<BoxShadow> md = [
    BoxShadow(color: AppColors.shadowMd, blurRadius: 8, offset: Offset(0, 2)),
  ];
